...
export function createArt(scene: Phaser.Scene) {
  ...
  for (let variant = 0; variant < 4; variant++)
    texture("grass" + variant, 16, 16, (c) => {
      rect(c, ["#638446", "#668848", "#69884a", "#618143"][variant], 0, 0, 16, 16);
      for (let x = 0; x < 16; x += 2) {
        for (let y = 0; y < 16; y += 2) {
          if ((x * 7 + y * 13 + variant * 3) % 5 === 0) {
            rect(c, "#587a3b", x, y, 2, 2);
          }
        }
      }
      for (let i = 0; i < 8; i++) {
        const x = (i * 7 + variant * 3) % 15,
          y = (i * 11 + variant) % 14;
        rect(c, i % 2 ? "#8cb060" : "#7aa050", x, y, 1, 3);
        rect(c, i % 2 ? "#a0ca6c" : "#8eb85c", x, y, 1, 1);
      }
    });
  texture("path", 16, 16, (c) => {
    rect(c, "#bd9e65", 0, 0, 16, 16);
    rect(c, "#c9aa70", 0, 1, 16, 13);
    rect(c, "#d4b67a", 1, 2, 14, 11);
    rect(c, "#a38652", 3, 5, 2, 1);
    rect(c, "#e2cf9e", 11, 10, 3, 1);
    rect(c, "#a38652", 8, 14, 1, 2);
    rect(c, "#8f7340", 2, 11, 2, 1);
    rect(c, "#e2cf9e", 12, 3, 1, 1);
  });
  texture("water", 16, 16, (c) => {
    rect(c, "#2b6b70", 0, 0, 16, 16);
    rect(c, "#3a8183", 0, 2, 16, 12);
    rect(c, "#4ca3a4", 1, 4, 8, 2);
    rect(c, "#6bc2c0", 9, 10, 5, 2);
    rect(c, "#85d9d7", 2, 5, 4, 1);
    rect(c, "#6bc2c0", 11, 4, 3, 1);
  });
  texture("tree", 40, 52, (c) => {
    rect(c, "#557646", 8, 43, 27, 6);
    rect(c, "#523c27", 17, 29, 8, 20);
    rect(c, "#705235", 18, 29, 5, 20);
    rect(c, "#946f48", 18, 31, 2, 15);
    rect(c, "#402d1d", 24, 32, 1, 14);
    rect(c, "#1a3b2a", 8, 9, 26, 29);
    rect(c, "#224a35", 4, 16, 32, 18);
    rect(c, "#2e6144", 6, 11, 28, 20);
    rect(c, "#3d7d55", 9, 5, 22, 24);
    rect(c, "#4a9463", 11, 3, 17, 18);
    rect(c, "#5cb078", 13, 3, 13, 12);
    rect(c, "#6ec78b", 15, 4, 8, 4);
    rect(c, "#6ec78b", 7, 18, 5, 3);
    rect(c, "#6ec78b", 28, 15, 6, 4);
    rect(c, "#224a35", 9, 34, 23, 4);
